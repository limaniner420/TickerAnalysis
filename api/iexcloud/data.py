...
def quote(symbol: str, params_ex: dict[str] = None, mode: str = "sandbox", ver: str = "stable"):
    """ 
    ...
    r = req.get(url = url_final,params = params_ex)
...
def hist_price(symbol: str, range: str, params_ex: dict[str] = None, mode: str = "sandbox", ver: str = "stable"):
    ...
    params_ex: list of applicable parameters. Optional.
    mode: Specify whether to access sandbox ("sandbox") data or real ("cloud") data. Polling real data may incur charges. Default sandbox.
    ver: Specify api version. Default stable.
...
def batch(symbols: list[str], types: list[str], range: str = None, params_ex: dict[str] = None, mode: str = "sandbox", ver: str = "stable"):
    ...
    See: https://iexcloud.io/docs/api/#batch-requests
    """
